          ...
          <div className="border border-gray-200 rounded-xl p-8 bg-white relative overflow-hidden">
            ...
            {activeTab === 'upload' && (
              <div className="space-y-6">
                ...
                <div className="border-2 border-dashed border-gray-200 rounded-lg p-8 text-center hover:border-[#0090FF] transition-colors cursor-pointer bg-white relative overflow-hidden">
                  {/* Diagonal Grid with Blue */}
                  <div
                    className="absolute inset-0 z-0 pointer-events-none"
                    style={{
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      ...
                      <label key={index} className="flex items-start space-x-3 p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-opacity bg-white relative overflow-hidden">
                        {/* Diagonal Grid with Blue */}
                        <div
                          className="absolute inset-0 z-0 pointer-events-none"
                          style={{
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={index} className="flex justify-between items-center p-3 border border-gray-200 rounded-lg bg-white relative overflow-hidden">
                        {/* Diagonal Grid with Blue */}
                        <div
                          className="absolute inset-0 z-0 pointer-events-none"
                          style={{
