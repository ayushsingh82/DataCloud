        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/datasets" className="text-gray-400 hover:text-blue-400 transition-colors">
                  Browse Datasets
                </Link>
              </li>
              <li>
                <Link href="/sellers" className="text-gray-400 hover:text-blue-400 transition-colors">
                  Sell Data
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/tutorials" className="text-gray-400 hover:text-blue-400 transition-colors">
                  Tutorials
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="https://twitter.com/datacloud" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
                  Twitter
                </a>
              </li>
              <li>
                <a href="https://discord.gg/datacloud" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
                  Discord
                </a>
              </li>
              <li>
                <a href="https://github.com/datacloud" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
                  GitHub
                </a>
              </li>
              <li>
